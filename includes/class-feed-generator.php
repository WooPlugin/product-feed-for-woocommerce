...
class GSWC_Feed_Generator {
    ...
    public static function generate() {
        ...
        update_option('gswc_feed_product_count', $result);
     ...
     * @return int|WP_Error Number of items written, or error.
     */
    private static function generate_google_feed($products) {
        ...
        foreach ($products as $product) {
            $item_count += self::write_product_item($xml, $product, $default_brand, $default_condition, $customization);
        }
        ...
        if ($product->is_type('variable')) {
            ...
            foreach ($product->get_children() as $variation_id) {
                ...
                if ($variation && $variation->is_purchasable()) {
                    $count += self::write_product_item($xml, $variation, $default_brand, $default_condition, $customization);
                }
            }
            return $count;
        }
